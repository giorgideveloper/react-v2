        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-10">
              For inquiries regarding forensic services, case submissions, or
              general information, please reach out through any of the following
              channels or use the contact form.
            </p>
